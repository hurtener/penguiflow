...
export interface AgentStore {
  ...
  readonly plannerConfig: ConfigItem[];
  readonly services: ServiceInfo[];
  readonly catalog: ToolInfo[];
  setFromResponse(data: MetaResponse): void;
  reset(): void;
}
...
export function setAgentStore(store: AgentStore = createAgentStore()): AgentStore {
