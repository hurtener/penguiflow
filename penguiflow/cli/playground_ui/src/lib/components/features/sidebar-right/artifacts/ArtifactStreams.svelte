...
{#if trajectoryStore.hasArtifacts}
  <div class="section">
    <div class="title-small">Artifact Streams</div>
    {#each Object.entries(trajectoryStore.artifactStreams) as [streamId, chunks] (streamId)}
      <div class="artifact-row">
        <Pill variant="ghost" size="small">{streamId}</Pill>
