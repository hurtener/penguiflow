import{p as se,a as i,s as h,b as I,L as ne,d as p,N as oe,D as N,A as k,i as L,g as a,n as g,r as ie,f as b,t as J,m as ae,e as re,O as de,c as z,l as ce,k as me,F as D,G as le}from"./index-jmKqvf5i.js";var ue=b('<div class="mcp-app-loading svelte-134bwg1">Loading MCP App...</div>'),pe=b('<div class="mcp-app-error svelte-134bwg1"> </div>'),fe=b('<iframe title="MCP App"></iframe>');function ge(F,o){se(o,!0);let _=i(o,"artifact_url",3,void 0),j=i(o,"html",3,void 0),m=i(o,"csp",19,()=>({})),G=i(o,"permissions",19,()=>({})),C=i(o,"tool_data",3,void 0),M=i(o,"namespace",3,void 0),x=i(o,"session_id",3,void 0),R=i(o,"tenant_id",3,void 0),S=i(o,"user_id",3,void 0),W=i(o,"height",3,"500px"),U=i(o,"prefers_border",3,!1),T=i(o,"sandbox",3,void 0),B=i(o,"onToolCall",3,void 0),q=i(o,"onSendMessage",3,void 0),l=h(void 0),E=h(I(W())),v=h(I(j()??"")),A=h(!!_()),w=h("");const K=z(()=>()=>{if(T())return T();const e=["allow-scripts","allow-forms"];return G()?.clipboard_write&&e.push("allow-same-origin"),e.join(" ")});function Q(){const e=["default-src 'none'","script-src 'unsafe-inline'","style-src 'unsafe-inline'"];if(m()?.connect_domains?.length&&e.push(`connect-src ${m().connect_domains.join(" ")}`),m()?.resource_domains?.length){const t=m().resource_domains.join(" ");e.push(`script-src 'unsafe-inline' ${t}`),e.push(`img-src ${t}`),e.push(`font-src ${t}`),e.push(`style-src 'unsafe-inline' ${t}`)}return m()?.frame_domains?.length&&e.push(`frame-src ${m().frame_domains.join(" ")}`),`<meta http-equiv="Content-Security-Policy" content="${e.join("; ")}">`}function V(e){const t=Q(),s=`
<script>
(function() {
  const MCP_ORIGIN = '*';
  let _jsonrpcId = 0;
