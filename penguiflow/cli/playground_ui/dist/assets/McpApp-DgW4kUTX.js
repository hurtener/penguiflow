import{p as Ae,a as d,s as g,b as Te,u as G,c as a,o as Me,d as V,f as Q,i as H,g as s,e as x,h as Se,j as L,t as K,k as Re,l as Pe,m as Ee,n as X,q as Oe,r as Ie,w as Y,x as ke}from"./index-CMZeEQZE.js";var Le=L('<div class="mcp-app-loading svelte-134bwg1">Loading MCP App...</div>'),ze=L('<div class="mcp-app-error svelte-134bwg1"> </div>'),qe=L('<iframe title="MCP App"></iframe>');function Ne($,c){Ae(c,!0);const ee="2026-01-26";let z=d(c,"artifact_url",3,void 0),R=d(c,"html",3,void 0),u=d(c,"csp",19,()=>({})),C=d(c,"permissions",19,()=>({})),j=d(c,"tool_data",3,void 0),te=d(c,"tool_input",19,()=>({})),A=d(c,"namespace",3,void 0),q=d(c,"session_id",3,void 0),D=d(c,"tenant_id",3,void 0),N=d(c,"user_id",3,void 0),P=d(c,"height",3,"500px"),ne=d(c,"prefers_border",3,!1),oe=d(c,"sandbox",3,void 0),ie=d(c,"onToolCall",3,void 0),W=d(c,"onSendMessage",3,void 0),p=g(void 0),h=g("500px"),y=g(""),w=g(!1),_=g(""),E=g(!1),b=g(Te({}));const se=X(()=>()=>{const e=new Set((oe()??"allow-scripts allow-forms").split(/\s+/).map(t=>t.trim()).filter(Boolean));return e.add("allow-same-origin"),Array.from(e).join(" ")});function re(){const e=["'unsafe-inline'"],t=["'unsafe-inline'"],n=["data:","blob:"],o=["data:"],i=["default-src 'none'"];if(u()?.connect_domains?.length&&i.push(`connect-src ${u().connect_domains.join(" ")}`),u()?.resource_domains?.length){const r=u().resource_domains.join(" ");e.push(r),t.push(r),n.push(r),o.push(r)}return u()?.frame_domains?.length&&i.push(`frame-src ${u().frame_domains.join(" ")}`),i.push(`script-src ${e.join(" ")}`),i.push(`style-src ${t.join(" ")}`),i.push(`img-src ${n.join(" ")}`),i.push(`font-src ${o.join(" ")}`),`<meta http-equiv="Content-Security-Policy" content="${i.join("; ")}">`}function ae(e){const t=re(),n=`
<script>
(function() {
  const MCP_ORIGIN = '*';
  let _jsonrpcId = 0;
