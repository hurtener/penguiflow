"""Minimal flow showing HuggingFace prompt-injection guardrail wiring."""
...
from .rule import HuggingFaceJailbreakRule
...
async def main() -> None:
    ...
    rule_registry.register(HuggingFaceJailbreakRule())
